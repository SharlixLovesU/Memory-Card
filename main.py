...
q2 = Question("Квітка", "flower", "kvitka", "sunflower", "flowey")
q3 = Question("Луна", "moon", "sun", "moonlight", "mun")
q4 = Question("Кішка", "cat", "kit", "catty", "kot")
...
def menu_generation():
    ...
    text =  f'Разів відповіли: {cur_q.count_asked}\n' \
            f'Вірних відповідей: {cur_q.count_right_}\n' \
            f'Разів відповіли: {round(c, 2)}%' 
